...
export class UsersControllerClient implements IUsersControllerClient {
	...
	protected processGetUser(response: Response): Promise<UserDTO> {
		...
		if (status === 200) {
			...
			return response.text().then((_responseText) => {
				return throwException("No user with this ID exists", status, _responseText, _headers)
			})
		} else if (status !== 200 && status !== 204) {
			return response.text().then((_responseText) => {
				return throwException(
	...
	protected processDeleteUser(response: Response): Promise<UserDTO> {
		...
		if (status === 200) {
			...
			return response.text().then((_responseText) => {
				return throwException("No user with the given id exists", status, _responseText, _headers)
			})
		} else if (status !== 200 && status !== 204) {
			return response.text().then((_responseText) => {
				return throwException(
	...
	protected processSetUserMemberships(response: Response): Promise<UserMembershipsDTO> {
		const status = response.status
		let _headers: any = {}
		if (response.headers && response.headers.forEach) {
			response.headers.forEach((v: any, k: any) => (_headers[k] = v))
...
export class GroupsControllerClient implements IGroupsControllerClient {
	...
	protected processGetGroup(response: Response): Promise<GroupDTO> {
		...
		if (status === 200) {
			...
			return response.text().then((_responseText) => {
				return throwException("No group with this ID exists", status, _responseText, _headers)
			})
		} else if (status !== 200 && status !== 204) {
			return response.text().then((_responseText) => {
				return throwException(
	...
	protected processDeleteGroup(response: Response): Promise<GroupDTO> {
		...
		if (status === 200) {
			...
			return response.text().then((_responseText) => {
				return throwException("No group with the given id exists", status, _responseText, _headers)
			})
		} else if (status !== 200 && status !== 204) {
			return response.text().then((_responseText) => {
				return throwException(
	...
	protected processSetMembers(response: Response): Promise<GroupMembershipsDTO> {
		const status = response.status
		let _headers: any = {}
		if (response.headers && response.headers.forEach) {
			response.headers.forEach((v: any, k: any) => (_headers[k] = v))
...
export class AuthControllerClient implements IAuthControllerClient {
	...
	protected processAuth(response: Response): Promise<AuthResponseDTO> {
		...
		if (status === 200) {
			...
			return response.text().then((_responseText) => {
				return throwException("UserName or password incorrect", status, _responseText, _headers)
			})
		} else if (status !== 200 && status !== 204) {
			return response.text().then((_responseText) => {
				return throwException(
