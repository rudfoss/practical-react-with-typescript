import { UserDbApiClientBaseClass } from "./UserDbApiClientBaseClass"
...
export class AppControllerClient extends UserDbApiClientBaseClass implements IAppControllerClient {
...
export class AuthControllerClient extends UserDbApiClientBaseClass implements IAuthControllerClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export class AuthUserControllerClient extends UserDbApiClientBaseClass implements IAuthUserControllerClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export class UsersControllerClient extends UserDbApiClientBaseClass implements IUsersControllerClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export class GroupsControllerClient extends UserDbApiClientBaseClass implements IGroupsControllerClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
